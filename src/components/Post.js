    ...
    return (
        <div className="col d-flex justify-content-center">
            <div className="card mb-4 shadow-sm" style={{ width: '18rem'}}>
                <img src={postimage} className="card-img-top img-fluid" alt="post" />
                <div className="card-body">
                    <div className='container-fluid'>
                        ...
                        <div className='row'>
                            <p>In ut ante eget turpis congue consequat nec ut purus. Duis in aliquet mauris, et porttitor metus.</p>
                        </div>
                        <a href="#" className="card-link text-muted text-decoration-none">
                            ...
                            <span className='ms-1'>Comments (15)</span>
                        </a>
                    </div>
